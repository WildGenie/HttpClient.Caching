namespace CacheCow.Client.Tests
{
    ...
    public class SerialisationTests
    {
        ...
        {
            var stream =
                Assembly.GetExecutingAssembly().GetManifestResourceStream("CacheCow.Client.Tests.Data.Request.cs");
        ...
        {
            var stream =
                Assembly.GetExecutingAssembly().GetManifestResourceStream("CacheCow.Client.Tests.Data.Response.cs");
            var serializer = new MessageContentHttpMessageSerializer();
