namespace CacheCow.Client.Tests
{
    ...
    {
        private readonly string _version = Assembly.GetAssembly(typeof(CacheCowHeader))
        ...
        public void ParseTest_Successful()
        {
            ...
            var result = CacheCowHeader.TryParse("1.0;was-stale=true;not-cacheable=false;retrieved-from-cache=true;",
                out header);
